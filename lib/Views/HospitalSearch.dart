...
class HospitalSearch extends SearchDelegate {
  ...
  List<HospitalListData> searchResult = [];
  final Function (HospitalListData) onSelectItem;
  HospitalSearch({this.onSelectItem,this.data});
...
// adding a back button to close the search
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    return Container(
        margin: EdgeInsets.all(20),
        child: _hospitalListView(searchResult)
    );
  }
